...
class TraceabilityValidator:
    ...
    @staticmethod
    def validar_fechas_cosecha(fecha_siembra: date, fecha_cosecha: date) -> Tuple[bool, str]:
        ...
        if diferencia < 90:  # Mínimo 3 meses para mangos
            return False, "El período entre siembra y cosecha es muy corto para mangos"
        if diferencia > 365:  # Máximo 1 año
            return False, "El período entre siembra y cosecha es muy largo"
        
        return True, "Fechas válidas"
    
    @staticmethod
    def validar_temperatura_transporte(temperatura: Decimal) -> Tuple[bool, str]:
    ...
    @staticmethod
    def validar_proceso_transformacion(
